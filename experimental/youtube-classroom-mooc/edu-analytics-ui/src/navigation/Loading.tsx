...
const Loading = () => {
  return (
    <div style={outerStyles}>
      <svg style={spinnerStyles} className="animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        <circle className="opacity-25 text-base-300" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
