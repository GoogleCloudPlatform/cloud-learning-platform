...
Feature: Retrieve messages from Pub/Sub and push them to bigquery
  ...
  Scenario: Roaster Changes Occurs in a registered Classroom
    ...
    Then Pipline get user related details from classroom and store user details and Push filter message to lms notifications
  ...
  Scenario: Course Work changes Occurs in a registered Classroom
    ...
    Then Pipline get course work details from classroom and store course work details and Push filter message to lms notifications
  
  Scenario: Course Work Submission changes Occurs in a registered Classroom
    Given A student submitted a course work
    When Pipline got messages related to Submitted Course work 
    Then Pipline get submitted course work details from classroom and store Submitted Course Work details and Push filter message to lms notifications