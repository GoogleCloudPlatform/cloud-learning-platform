...
Feature: Get Anaytics data
  Scenario: Retrieve Anaytics data using valid student email
  ...
  Scenario: Retrieve Anaytics data using valid student id
  ...
  Scenario: Retrieve Anaytics data using invalid student id
  ...
  Scenario: Retrieve Anaytics data using invalid student email
