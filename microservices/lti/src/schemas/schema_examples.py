...
FULL_TOOL_EXAMPLE = {
    ...
    **BASIC_TOOL_EXAMPLE, "client_id": "174875a8-9c35-4963-89f7-cae31be3d78e",
    ...
    "issuer": ISSUER,
    "platform_auth_url": f"{ISSUER}//api/v1/authorize",
    "platform_token_url": f"{ISSUER}//api/v1/token",
    "platform_keyset_url": f"{ISSUER}//api/v1/jwks",
    "is_archived": False,
...
FULL_PLATFORM_EXAMPLE = {
    "uuid": "asd98798as7dhjgkjsdfh",
    **BASIC_PLATFORM_EXAMPLE,
    "tool_auth_url": f"{ISSUER}//api/v1/authorize",
    "tool_token_url": f"{ISSUER}//api/v1/token",
    "tool_keyset_url": f"{ISSUER}//api/v1/jwks/SoD1uf9V1nc9",
}
