...
def test_replay_notifications(client_with_emulator):
  with mock.patch("routes.lms-notifications.Logger"):
    with mock.patch("routes.lms-notifications.background_tasks.add_task"):
      response = client_with_emulator.post(
        API_URL,json=INPUT_REPLAY_NOTIFICATION_EXAMPLE)
