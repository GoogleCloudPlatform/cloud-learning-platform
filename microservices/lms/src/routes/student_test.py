...
def test_get_student_course_progress_percent(client_with_emulator):
  url = API_URL + "/student/get_progress_percentage/?course_id=504551481098&student_email=saurav.minimi@gmail.com"
  # course_details = {"course_id":504551481098,"student_email":"saurav.minimi@gmail.com"}
  # with mock.patch("routes.student.classroom_crud.get_course_work_list"):
  #     with mock.patch("routes.student.classroom_crud.get_submitted_course_work_list"):
