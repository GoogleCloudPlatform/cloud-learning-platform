...
@router.get("/{course_template_id}/instructional_designers",response_model=ListInstructionalDesigner)
def list_instructional_designers(course_template_id: str):
    """List instructionl designer for course template
      ...
      Returns:
          InstructionalDesignerModel:  list of InstructionalDesignerModel 
          NotFoundErrorResponseModel: if the Course Template not found,
          InternalServerErrorResponseModel:
      """
    try:
        Logger.info(f"this is course template {course_template_id}")
        course_template = CourseTemplate.find_by_id(course_template_id)
...
@router.get("/{course_template_id}/instructional_designers/{instructional_designer}",
...
def get_instructional_designer(course_template_id: str,
    ...
    """Get a Course Template endpoint
      ...
      Returns:
          InstructionalDesignerModel: InstructionalDesignerModel of course templat
          NotFoundErrorResponseModel: if the Course Template not found,
          InternalServerErrorResponseModel:
              if the get Course Template raises an exception
      """
    try:
        ...
        user_id = get_user_id(user=instructional_designer, headers=headers)
